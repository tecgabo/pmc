...
templates = {
    ...
    "Exemplo de Alteração no Sistema de Propulsão": {
        'justificativas': "Prefeitos de algumas cidades contempladas com lanchas escolares à gasolina do Projeto 'Lanchas Escolares' do FNDE reclamaram do alto custo com combustível. Muitas delas estão paradas.",
        'pitch': "Alteração do sistema de propulsão em protótipo de lanchas escolares.",
        'produto': "• Lancha protótipo com novo sistema de propulsão instalado e testado.\n• Desenhos e relatórios de maneira que o protótipo possa ser replicado.",
        'stakeholders': "• FNDE\n• FADESP\n• Prof. Roberto Pacha/FENAV (Coordenador do Projeto 'Lanchas escolares')\n• Prof. André Mesquita/FEM (Coordenador Técnico do Projeto LE)",
        'premissas': "- Recebimento de Lancha para ser o protótipo\n- Compra de Motor",
        'riscos': "- Não recebimento de lancha para ser o protótipo\n- Não haver compra de Motor\n- Abandono de componentes da equipe do projeto",
        'objetivos': "Alterar o sistema de propulsão de protótipo de lanchas escolares visando redução no consumo de combustível até 06/2016.",
        'requisitos': "• A lancha cujo protótipo será alterado é aquela fabricada pela marinha no Projeto 'Lanchas Escolares', que tem como características:\n  - 7,30 m de comprimento\n  - Casco de alumínio\n  - Capacidade de 20 passageiros\n  - Velocidade de mínima de transporte 20 km/h\n• As modificações na lancha para recebimento do novo sistema de propulsão não afetará a estabilidade e a integridade estrutural da embarcação. Também não trará desconforto aos usuários em relação ao nível de vibração gerados.",
        'equipe': "• Gerente do Subprojeto: Prof. Alexandre Mesquita\n• Bolsistas de Graduação: Kelvin A. Pinheiro (FEM), Gélson Ferreira Silva Neto (FEM)\n• Aluno de TCC: Sérgio F. Soares (FEM)",
        'entregas': "1. Definição de Equipe e Escopo do sistema de propulsão\n2. Análise das Vibrações Transmitidas\n3. Análise de Estabilidade e Integridade Estrutural\n4. Definição do layout final\n5. Montagem do motor e alterações estruturais\n6. Entrega do Protótipo",
        'cronograma': "• F1 (15/01/2016): Definição de Equipe\n• F2 (15/02/2016): Análise de Vibrações\n• F3 (15/03/2016): Estabilidade e Estrutural\n• F4 (15/04/2016): Montagem do Motor\n• F5 (15/05/2016): Entrega do Protótipo",
        'beneficios': "• Lanchas com baixo consumo de combustível fazendo com que sejam plenamente utilizadas no transporte de estudantes de localidades ribeirinhas.",
        'restricoes': "• Prazo máximo de 1 ano para conclusão do projeto.\n• Os bolsistas da equipe (Kelvin e Sérgio) estarão disponíveis até o término do período letivo do ano corrente.",
        'custos': "• Bolsas de Pesquisa\n• Modificações na Lancha\n• Diárias/Passagens\n• Material Bibliográfico\n• Coxins de Vibração"
    }
}
